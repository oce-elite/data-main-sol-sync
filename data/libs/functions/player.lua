...
do
	local loyaltySystem = {
		...
		titles = {
			[1] = { name = "Scout of Oce Elite", points = 0 },
			[2] = { name = "Sentinel of Oce Elite", points = 30 },
			[3] = { name = "Steward of Oce Elite", points = 60 },
			[4] = { name = "Warden of Oce Elite", points = 90 },
			[5] = { name = "Squire of Oce Elite", points = 120 },
			[6] = { name = "Warrior of Oce Elite", points = 150 },
			[7] = { name = "Keeper of Oce Elite", points = 180 },
			[8] = { name = "Guardian of Oce Elite", points = 210 },
			[9] = { name = "Sage of Oce Elite", points = 240 },
			[10] = { name = "Savant of Oce Elite", points = 270 },
			[11] = { name = "Enlightened of Oce Elite", points = 300 },
		},
		bonus = {
			{ minPoints = 30, percentage = 10 },
			{ minPoints = 60, percentage = 20 },
			{ minPoints = 90, percentage = 30 },
			{ minPoints = 120, percentage = 40 },
			{ minPoints = 150, percentage = 50 },
			{ minPoints = 180, percentage = 60 },
			{ minPoints = 210, percentage = 70 },
			{ minPoints = 240, percentage = 80 },
			{ minPoints = 270, percentage = 90 },
			{ minPoints = 300, percentage = 100 },
		},
