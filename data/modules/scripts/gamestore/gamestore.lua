...
GameStore.Categories = {
	...
	--New stuff
	{
		icons = { "Category_Forge.png" },
		name = "Elite Shop",
		rookgaard = true,
		subclasses = { "Elite Items", "Buffs", "Foods" },
	},
--New items
	{
		...
		state = GameStore.States.STATE_NONE,
			offers = {
			{
				icons = { "Elite_Pouch.png" },
				name = "Elite Loot Pouch",
				price = 500,
				itemtype = 50372,
				count = 1,
				description = "Unlimited loot backpack! \n{storeinbox}\n{character}\n{once}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Elite_Teleport_Cube.png" },
				name = "Elite Teleport Cube",
				price = 500,
				itemtype = 50358,
				count = 1,
				description = "Teleport cube can take you to bosses/special areas! \n{storeinbox}\n{character}\n{once}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Elite_backpack.png" },
				name = "Elite Backpack",
				price = 500,
				itemtype = 37536,
				count = 1,
				movable = true,	
				description = "Elite Backpack has 200 slots never run out of space!",
			...
			},
			{
				...
				count = 1,
				movable = true,	
				description = "Try your luck with roulette (Random Items)!",
			...
			},
			{
				...
				itemtype = 24948,
				count = 1,
				description = "Unlimited food use any many times as you like never runs out! \n{storeinbox}\n{character}\n{once}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "Random_outfit.png" },
				name = "Random Outfit",
				price = 200,
				itemtype = 12905,
				count = 1,
				movable = true,	
				description = "Take your chances at a random outfit!",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				
			},
			{
				icons = { "Sell_all_loot.png" },
				name = "Loot seller",
				price = 700,
				itemtype = 50384,
				count = 1,
				description = "Sell all your loot on the go!\n{storeinbox}\n{character}\n{once}",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
			},
			{
				icons = { "silver.png" },
				...
				offers = {
					{
						...
						count = 5,
						movable = true,	
						description = "Reduces cooldown time for abilities or skills.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					},
					
					{
						...
						count = 5,
						movable = true,	
						description = "Drinking this potion temporarily increases critical hit chance.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Increases resistance to fire-based damage.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Increases resistance to ice-based damage.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Increases resistance to earth-based damage.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Increases resistance to energy-based damage.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Increases resistance to holy-based damage.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Increases resistance to death-based damage.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Increases overall physical damage resistance.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Amplifies the damage of fire-based attacks.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Amplifies the damage of ice-based attacks.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Amplifies the damage of earth-based attacks.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Amplifies the damage of energy-based attacks.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Amplifies the damage of holy-based attacks.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Amplifies the damage of death-based attacks.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					
					{
						...
						count = 5,
						movable = true,	
						description = "Amplifies the damage of physical attacks.",
						type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			
			{
				...
				price = 45,  -- Price for 15000x charges
				itemtype = 35286,
				charges = 15000,
				description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} Use it on an exercise dummy to train your axe fighting skill.\n{info} Usable 15000 times per piece.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			...
			
			{
				icons = { "Lasting_Exercise_Axe.png" },
				name = "Lasting Exercise Axe",
				price = 120,  -- Price for 45000x charges
				itemtype = 35286,
				charges = 45000,
				description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} Use it on an exercise dummy to train your axe fighting skill.\n{info} Usable 45000 times per piece.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
