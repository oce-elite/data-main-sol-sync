...
-- Special case: if there are 5 people and 4 unique vocations, set multiplier to 1.2 (120% bonus)
if partySize == 5 and uniqueVocationsCount == 4 then
    sharedExperienceMultiplier = 2.25
end
