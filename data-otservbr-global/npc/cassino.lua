...
local config = {
	...
	playerPosition = Position(32351, 32230, 7), -- NpcPos(x-2) player must stay on this position to talk with npc
	dicerCounter = Position(32351, 32231, 7), --	NpcPos(x-1, y-1) 	counter position
	diePos = Position(32353, 32231, 7), --NpcPos(y-1)
}
