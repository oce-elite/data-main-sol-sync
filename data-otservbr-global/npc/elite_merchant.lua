local internalNpcName = "Elite Merchant"
...
npcHandler:setMessage(MESSAGE_GREET, "Ah, a customer! Be greeted, |PLAYERNAME|! I can show you my {shop options}? I buy all kinds of loot, would you like to {trade}?.")
npcHandler:setMessage(MESSAGE_SENDTRADE, "Ah, a customer! Be greeted, |PLAYERNAME|! I can show you my {shop options}? I buy all kinds of loot, would you like to {trade}?.")
